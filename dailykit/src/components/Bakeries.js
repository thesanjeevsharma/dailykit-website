            ...
            <div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-3" > <h3 className="sidebar_heading">WHY SHOULD BAKERIES DO MEAL KITS?</h3>
                            <ul className="link_container">
                                <li><a href="#Recipes" className="sidebar_link">Recipes</a></li>
                                <li><a href="#Manufacturing/Fulfillment" className="sidebar_link">Manufacturing/Fulfillment</a></li>
                                <li><a href="#Market and Sell" className="sidebar_link">Market and Sell</a></li>
                                <li><a href="#Delivery" className="sidebar_link">Delivery</a></li>
                            </ul>
                        </div>
                         {/* <--first Para--> */}
                        <div className="col-6"><p className="para_first">
                            ...
                            <br /><br />
                            <h4 className="para2_heading" id="Recipes">Recipes</h4>
                            ...
                            <br /><br />
                            <h4 className="para2_heading" id="Manufacturing/Fulfillment">Manufacturing/Fulfillment</h4>
                            Dailykit solution can be very easily integrated inside your kitchen. Our simple and easy to use weighing scales will make portioning and packing so easy that even a child can pack meal kits (not that you should use child labour). The essence is that dailykit makes packing meal kits idiot proof, leaving no room for errors.
                            <br/><br/>
                            <h4 className="para2_heading" id="Market and Sell">Market and Sell</h4>
                            ...
                            <br /><br />
                            <h4 className="para2_heading" id="Delivery">Delivery</h4>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col">
                            <div className="card" style={{"width": "28rem","border":" 2px solid black"}}>
