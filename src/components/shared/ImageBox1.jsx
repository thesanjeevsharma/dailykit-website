          ...
          <div class="col-md-6 col-xs-10">
            <div class="card">
              <div class="card-body inner-box">
                ...
                {this.props.imagetext1 && <a href="/we_serve" class="btn btn-dark image1-button">
                  {this.props.imagetext1}
                </a>}
                {this.props.imagepara && <a href="#" class="btn btn-dark image1-button">
                  <h4 class="card-title nunito">  {this.props.imagepara[0].heading}</h4>
          ...
          <div class="col-md-6 col-xs-10">
            <div class="card">
              <div class="card-body inner-box">
                ...
                {this.props.imagetext2 && <a href="/we_serve" class="btn btn-dark image2-button">
                  {this.props.imagetext2}
                </a>}
                {this.props.imagepara && <a href="#" class="btn btn-dark image2-button">
                  <h4 class="card-title nunito">  {this.props.imagepara[1].heading}</h4>
                  <p class="card-text nunito" style={{ fontSize: "16px" }}>
